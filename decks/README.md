...
- **Source URL**: Moxfield or Archidekt link on its own line: `Source: https://...`  
  ...
  If the same **`Source:`** URL (or builder id) already exists under `decks/` or `reviews/`, the agent **reports the match** and **asks** whether to **update** that file or **create a new** one before saving.
